...
@section('content')
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
           Happy Hours Discount Management
...
<!--                   <a href="{{url('deal-of-day-add')}}" style="float: right"><button class="btn btn-info"><i class="fa fa-plus"></i>Add Deal of Day</button></a>  -->
 ...
 <a href="{{url("happy-hours-discount-edit/$discountval->id")}}" class="btn btn-info"><i class="fa fa-edit"></i></a>
                       </td>
                     </tr>
                      @endforeach
                    </tbody>                   
...
function updateDealOfDayStatus(id){
 ...
 $.ajax({
 url:"{{url('happy-hours-discount-status')}}",
 method:'post',
