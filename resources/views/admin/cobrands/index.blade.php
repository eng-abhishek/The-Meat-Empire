            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Co Brand List</h3>
                  <a href="{{url('co-brand-add')}}" style="float: right"><button class="btn btn-info"><i class="fa fa-plus"></i>Add Co Brand</button></a> 
                </div><!-- /.box-header -->
                <div class="box-body">
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      @foreach($coBrands as $key=>$categoryval)
                      <tr>
                        <td>{{$key+1}}</td>
                        <td>{{$categoryval->name}}</td>
                        <td>
                            <img src="{{ asset("uploads/cobrands/$categoryval->img")}}" width="50px">
                        </td>
...
<td>                  
                        <a href="{{url("co-brand-edit/$categoryval->id")}}" class="btn btn-info"><i class="fa fa-edit"></i></a>
                        <a href="{{url("co-brand-destroy/$categoryval->id")}}" class="btn btn-danger"><i class="fa fa-trash"></i></a>                
</td>
...
function updateCategoryStatus(id){
 ...
 $.ajax({
 url:"{{url('update-co-brand-status')}}",
 method:'post',
