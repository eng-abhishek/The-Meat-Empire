...
@section('title','Launching Discount')
@section('content')
...
<!--                   <a href="{{url('deal-of-day-add')}}" style="float: right"><button class="btn btn-info"><i class="fa fa-plus"></i>Add Deal of Day</button></a>  -->
 ...
 <a href="{{url("launching-discount-edit/$discountval->id")}}" class="btn btn-info"><i class="fa fa-edit"></i></a>
                       </td>
                     </tr>
                      @endforeach
                    </tbody>                   
...
function updateDealOfDayStatus(id){
 ...
 $.ajax({
 url:"{{url('update-launching-discount-status')}}",
 method:'post',
