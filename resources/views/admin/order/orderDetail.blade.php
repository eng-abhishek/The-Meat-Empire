            ...
            <div class="col-md-12">
              ...
              <div class="box box-primary">
                <div class="box-header">
                  ...
                  <a target="_blank" href="{{url('uploads/invoices/'.$order[0]->invoice)}}"><button type="button" name="invoice" style="float:right;" class="btn btn-info">Get Invoice <i class="fa fa-external-link"></i></button></a>
                </div><!-- /.box-header -->
                <!-- form start -->
