...
$product=FoodCategory::where('status','1')->where('category_type','ebc')->get()->toArray();
?>
            ...
            <div class="col-md-12">
              ...
              <div class="box box-primary">
                <div class="box-header">
                  <h3 class="box-title">CMS- Explore By Category</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                <form role="form" method="post" id="testimonialForm" action="{{url('store-cms-explore-by-category')}}" enctype="multipart/form-data">
                  <div class="box-body">
...
alert('Only Twelve Product Show On Explore By Category');
return false;
}
});
...
$.ajax({
 url:"{{url('get-update-explore-category-home-page-status')}}",
 method:'post',
