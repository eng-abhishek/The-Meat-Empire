...
<li aria-haspopup="true"><a href="#"><img src="{{asset('assets/front-end/img/cobrand.png')}}" width="15%"> </i>Co-brands</a>

   <ul class="sub-menu">
                
    @foreach($CoBrond as $CoBrondData)
                  <li aria-haspopup="true"><a href="{{url('category-product/'.$CoBrondData->id.'/cobrand')}}"><i class="fas fa-angle-right"></i>
                  <img src="{{asset('uploads/cobrands/'.$CoBrondData->img)}}" width="15%">
                  {{$CoBrondData->name}} 
                  </a></li>
@endforeach
